<div class="modal fade bs-example-modal-lg" id="subcategory-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" style="display: none;" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <form class="modal-content" action="<?= route_to('admin.add-subcategory') ?>" method="post" id="add_subcategory_form">
